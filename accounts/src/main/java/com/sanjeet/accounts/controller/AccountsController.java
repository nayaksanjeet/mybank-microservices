...
public class AccountsController {
    ...
    @ApiResponse(
            responseCode = "201",description = "HTTPStatus Code CREATED")
    ...
    @ApiResponse(
            responseCode = "200",description = "HTTPStatus Code OK")
    ...
    @ApiResponses ({
        @ApiResponse(
                responseCode = "200",description = "HTTPStatus Code OK"),
        @ApiResponse(
                responseCode = "417",description = "HTTPStatus Code INTERNAL_SERVER_ERROR")
    })
