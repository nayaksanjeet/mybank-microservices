package com.sanjeet.cards.controller;

import com.sanjeet.cards.constants.CardsConstants;
import com.sanjeet.cards.dto.CardsContactInfo;
import com.sanjeet.cards.dto.CardsDto;
import com.sanjeet.cards.dto.ErrorResponseDto;
import com.sanjeet.cards.dto.ResponseDto;
import com.sanjeet.cards.service.ICardsService;
...
public class CardsController {
    ...
    @Operation(
            ...
            description = "REST API to get build version of Cards Microservices")
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
                    description = "HTTP Status OK"
    ...
    @Operation(
            ...
            description = "REST API to get contact info of Cards Microservices in case of issues")
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
                    description = "HTTP Status OK"
    ...
    public ResponseEntity<CardsContactInfo> getContactInfo() {
        return ResponseEntity.ok().body(cardsContactInfo);
    }

    @Operation(
            summary = "Java Version REST API",
            description = "REST API to get Java version of Cards Microservices")
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
                    description = "HTTP Status OK"
